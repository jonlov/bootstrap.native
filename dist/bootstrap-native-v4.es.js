// Native Javascript for Bootstrap 4 v2.0.23 | © dnp_theme | MIT-License
  ...
  // ALERT DEFINITION
  // ================
  export const Alert = function( element ) {
  ...
  // BUTTON DEFINITION
  // ===================
  export const Button = function( element ) {
  ...
  // CAROUSEL DEFINITION
  // ===================
  export const Carousel = function( element, options ) {
  ...
  // COLLAPSE DEFINITION
  // ===================
  export const Collapse = function( element, options ) {
  ...
  // DROPDOWN DEFINITION
  // ===================
  export const Dropdown = function( element, option ) {
  ...
  // MODAL DEFINITION
  // ===============
  export const Modal = function(element, options) { // element can be the modal/triggering button
  ...
  // POPOVER DEFINITION
  // ==================
  export const Popover = function( element, options ) {
  ...
  // ====================
  export const ScrollSpy = function(element, options) {
  ...
  // TAB DEFINITION
  // ==============
  export const Tab = function( element, options ) {
  ...
  // TOOLTIP DEFINITION
  // ==================
  export const Tooltip = function( element,options ) {
